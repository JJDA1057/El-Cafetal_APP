...
namespace El_Cafetal_APP
{
    public partial class EditarSemilla : Form
    {
        ...
        private void dateTimePicker2_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No puedes seleccionar una fecha pasada.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                dateTimePicker2.Value = DateTime.Today; // Restablece a la fecha actual
            }
